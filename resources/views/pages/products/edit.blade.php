            ...
            <div class="card my-4">
                <div class="card-body px-0 pb-2">
                    <div class="px-4 d-flex justify-content-end">
                        <div>
                            <a class="btn btn-outline-dark btn-sm" href="{{ route('products.index') }}">المنتجات </a>
                        </div>
                    </div>
                    <div class="card-body px-4 pb-2">
                        <form action="{{ route('products.update', $product->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group px-3 mb-4">
                                        ...
                                        <input type="text" name="delivery_company"
                                            ...
                                            required dir="auto" value="{{ $product->delivery_company }}">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group px-3 mb-4">
                                        ...
                                        <input type="text" name="name" class="form-control text-center bg-light p-2"
                                            id="name" placeholder="اسم المنتج " value="{{ $product->name }}" required>
                                        @error('name')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group px-3 mb-4">
                                        ...
                                        <input type="text" name="barcode" class="form-control text-center bg-light p-2"
                                            id="barcode" placeholder="كود بار" required value="{{ $product->barcode }}"
                                            value="{{ \Str::random(20) }}">
                                        @error('barcode')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group px-3 mb-4">
                                        ...
                                        <input type="number" min="0" name="wholesale_price"
                                            class="form-control text-center bg-light p-2" id="wholesale_price"
                                            placeholder="" required value="{{ $product->wholesale_price }}">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group px-3 mb-4">
                                        ...
                                        <input type="number" min="0" name="retail_price"
                                            class="form-control text-center bg-light p-2" id="retail_price" placeholder=""
                                            required value="{{ $product->retail_price }}">
                                        @error('retail_price')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group px-3 mb-4">
                                        ...
                                        <input type="number" min="0" name="weight"
                                            class="form-control text-center bg-light p-2" id="weight" placeholder=""
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group px-3 mb-4">
                                        ...
                                        <select class="form-control text-center bg-light p-2" name="category_id"
                                            id="category_id">
                                            <option value=""></option>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group px-3 mb-4">
                                        ...
                                        <select class="form-control text-center bg-light p-2" name="subcategory_id"
                                            id="subcategory_id">
                                            <option value=""></option>
                            ...
                            <div class="collapse mb-5 {{ $prices->count() > 0 ? 'show' : '' }}" id="collapseExample">
                                                    ...
                                                    <tr>
                                                        <td class="p-2">
                                                            <input type="hidden" name="states[]"
                                                                value="{{ $price?->state?->id }}">
                                                            <strong>{{ $price?->state?->id ?? 0 }} -
                                                                {{ $price?->state?->name ?? '/' }}</strong>
                                                        </td>

                                                        <td>
                                                            <input type="number"
                                                                value="{{ $price?->wholesale_price ?? 0 }}"
                                                                class="form-control bg-light p-2 text-center"
